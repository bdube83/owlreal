...
<p>					
	...
	<?php
		//echo $upload_bt;
	?>
	<input class="_button" type="" name="send" onclick="uploadImage()" value="Post" id="send"/>
	<input class="_button" type="" name="send" onclick="uploadImageP()" value="Private Post" id="send"/>
